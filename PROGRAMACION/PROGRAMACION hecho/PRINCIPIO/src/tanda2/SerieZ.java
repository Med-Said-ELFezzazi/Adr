...
public class SerieZ {
	...
	public static void main(String[] args) {
		int numFilas;
		System.out.println("Introduce el número de filas que desea (Superior a 2)");
		numFilas = Consola.leeInt();
		while (numFilas <= 2) {
			System.out.println("El número "+numFilas+ " no es un número valido, introduce un número superior a 2");
			numFilas = Consola.leeInt();
		}
